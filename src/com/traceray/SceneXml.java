...
public class SceneXml {
	...
	public int getRecursionDepth(){
		int rd=Integer.parseInt(((Element)xml.getElementsByTagName("scene").item(0)).getAttribute("recursionDepth"));
		//System.out.println("[SceneXml] geRecursionDepth says: "+rd);
		return rd;
	}
